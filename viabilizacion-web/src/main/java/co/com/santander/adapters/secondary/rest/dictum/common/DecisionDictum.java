package co.com.santander.adapters.secondary.rest.dictum.common;

public class DecisionDictum {
    ...
    public static final String SIN_RESPUESTA = "NO EXISTE POSIBLE RESPUESTA";
}
